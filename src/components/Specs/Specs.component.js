...
import { SpecsWrapper } from './Specs.styled';
      ...
      <Container>
        ...
        <SpecItem title='Compatibilidad con video'>
          ...
          <ul>
            ...
            <li>
              Hasta dos monitores externos con resolución de 4096 x 2304 hasta
              60 Hz
            </li>
          </ul>
        ...
        <SpecItem title='Teclado y trackpad'>
          ...
          <ul>
            ...
            <li>
              Trackpad Force Touch con control preciso del cursor y sensibilidad
              a la presión. Permite clics fuertes, aceleradores, trazos
              sensibles a la presión y gestos Multi‑Touch
            </li>
          </ul>
        </SpecItem>
